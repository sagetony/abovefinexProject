                                ...
                                <table class="table table-bordered table-hover table-striped text-nowrap mb-0 tx-13" >
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            <td>{{ $datawithdraw->withdraw_id}}</td>
                                            <td>{{ $datawithdraw->username}}</td>
                                            <td>{{ $datawithdraw->amount }}</td>
                                            <td>{{ $datawithdraw->type_withdraw }}</td>
                                            <td>{{ $datawithdraw->wallet_address }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    @if($datawithdraw->status =='CONFIRM')
                                                           <button class='btn btn-success' data-toggle='modal' title='Lock User' data-target='#myModalLOCK{{$datawithdraw->withdraw_id}}'><i class='fa fa-unlock'></i></button>
                                                    @else
                                                        <button class='btn btn-danger' data-toggle='modal' title='Unlock User' data-target='#myModalUNLOCK{{ $datawithdraw->withdraw_id }}'><i class='fa fa-lock'></i></button>
                                                    @endif
                                                    <a class="btn btn-info" data-toggle="" title="Add Interest" href="#"><i class="fa fa-edit"></i></a> 
                                                    <button class="btn btn-danger" data-toggle="modal" title="Delete User" data-target='#myModalDELETED{{ $datawithdraw->withdraw_id }}'><i class="fa fa-trash"></i></button>
                                            ...
                                            <div id="myModalLOCK{{$datawithdraw->withdraw_id }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="submit" class="btn btn-danger" href="{{Route('adminwithdraw', ['unconfirmid' => $datawithdraw->withdraw_id])}} ">Pending Transaction</a>
                                            ...
                                            <div id="myModalDELETED{{$datawithdraw->withdraw_id}}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a type="button" class="btn btn-danger" href="{{ Route('adminwithdraw', ['deleteid' => $datawithdraw->withdraw_id]) }}">Delete Transaction</a>
                                                            <button type="button" class="btn btn-default"  data-dismiss="modal">Close</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <!-- Modal -->
                                            <div id="myModalUNLOCK{{ $datawithdraw->withdraw_id }}" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger" href="{{ Route('adminwithdraw', ['confirmid' =>  $datawithdraw->withdraw_id]) }}">Confirm Transaction</a>
                                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
