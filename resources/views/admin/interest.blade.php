                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                ...
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Transaction ID</label> <input class="form-control"name="id" type="text" id="id" value="{{ $datadeposits->transaction_id }}">
                                                </div>
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Interest Rate (%)</label> <input class="form-control"name="amount" type="text" id="amount" value="{{ $datadeposits->planAmount }}">
                                                </div>
                                                <div class="form-group">
