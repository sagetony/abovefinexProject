                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
                                            <div class="card card-body pd-10 pd-md-20 border shadow-none">
                                                <h5 class="card-title mg-b-20">Interest</h5>
                                                <form action="{{ route('addinterest') }}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Username</label> <input class="form-control"name="username" type="text" id="id" value="">
                                                </div>
                                               
                                                <div class="form-group">
                                                    <label class="main-content-label tx-11 tx-medium tx-gray-600">Amount ($)</label> <input class="form-control"name="amount" type="text" id="id" value="">
                                                </div>
                                                
                                                <button class="btn btn-main-primary btn-block" name="sub" type="submit">Deposit</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
