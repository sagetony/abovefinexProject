            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align:justify;">
                  <p style="margin: 0;">Congratulations, you have successfully subscribed to Abovefinex VIP signal. You will be receiving you daily signals as SMS from your mobile phone.</p>
                </td>
              </tr>
              <!-- BULLETPROOF BUTTON -->
