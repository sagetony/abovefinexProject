...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Poppins', sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
    We're thrilled to have you here! Get ready to dive into your new account on AboveFinex.
</div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align:justify;">
                  <p style="margin: 0;">Thank you for joining AboveFinex Forex Investment Limited, one of the world’s leading financial management and forex investment platform.</p>
                </td>
              </tr>
              <!-- BULLETPROOF BUTTON -->
              <tr>
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 20px 30px; color: #666666; font-family: &apos;Lato&apos;, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px; text-align:justify;">
                  <p style="margin: 0;">Trusted by thousands worldwide, AboveFinex Forex Investment Limited platform is dedicated to increasing the freedom of money for users, and features an unmatched portfolio of financial products and offerings, which includes: Assets Management, Forex investment, Forex Signals, Forex Training, data and research.</p>
                </td>
              </tr>
              <!-- COPY -->
              <tr>
