...
<head>
    ...
    <title>VIP Signal | AboveFinex </title>
    <!-- Favicon icon -->
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-2 d-block d-sm-flex flex-wrap border-0">
								<div class="mb-3">
									<h4 class="fs-20 text-black">VIP SIGNAL</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><span class="text-black">{{ \Carbon\Carbon::parse($dat->created_at)->format('d-m-Y / h:i:s A')}}
                                                        </span></td>
                                                    
                                                    <td><span class="text-black">{{ $dat->Message }}</span>
                                                        </td>
