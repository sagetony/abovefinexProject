...
<head>
    ...
    <title>Transfer Funds | AboveFinex </title>
    <!-- Favicon icon -->
					...
					<div class="col-xl-7 col-xxl-7">
						<div class="card">
							<div class="card-header border-0 pb-0">
								<h5 class="mb-0 text-black fs-20">Transfer Funds</h5>
                                ...
                                <div class="basic-form">
                                    <form action="{{ route('transfer') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="default-select  form-control col-sm-11" name="transfer_type" >
                                        ...
                                        <div class="mb-3">
                                            <label class="col-sm-6 col-form-label">To:</label>
                                                    <select class="default-select  form-control col-sm-11" name="walletothers" >
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class=" col-sm-11 btn btn-primary btn-block">Transfer Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
