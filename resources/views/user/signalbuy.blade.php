...
<head>
    ...
    <title>Buy Signal | AboveFinex </title>
    <!-- Favicon icon -->
    ...
    <a href="{{ route('fund') }}" class="btn btn-primary btn-rounded"> Fund Wallet</a>
					...
					<div class="col-xl-7 col-xxl-7">
						<div class="card">
							<div class="card-header border-0 pb-0">
								<h5 class="mb-0 text-black fs-20">Signal Purchase</h5>
								
							</div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('signalbuy') }}" method="post">
                                        @csrf
                                       
                                        <div class="mb-3">
                                            <label class="col-sm-6 col-form-label">Signal Package</label>
                                           
                                                <select id="plan" name="plan" class="form-control col-sm-9">
                                        ...
                                        {{-- <div class="mb-3">
                                            <label class="col-sm-6 col-form-label">Amount ($)</label>
															<div class="col-sm-9">
																<input type="text" name="amount" class="form-control" id="amount" placeholder="20" value="20"disabled>
															</div>
                                        </div> --}}
                                        <div class="text-center">
                                            <button type="submit" class=" col-sm-9 btn btn-primary btn-block">Buy Signal Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header pb-2 d-block d-sm-flex flex-wrap border-0">
                            <div class="mb-3">
                                <h4 class="fs-20 text-black">Signal Activity</h4>
                                    ...
                                    <table class="table shadow-hover short-one card-table border-no">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="font-w600 text-black">Day {{ $robots->dayCounter }}</span>
                                                </td>
                                                <td>
                                                    <span class="font-w600 text-black">{{ $robots->status }}</span>
                                                </td>
                                               
                                                {{-- <td><a class="btn-link text-success float-end" href="javascript:void(0);">{{ $robot->status }}</a></td>
                                                
                                                    <td><a href="{{ route('robotrenew', ['id'=> $signal->signalpurchaseID]) }}" style="color: white;"><button type="submit" class=" col-sm-9 btn btn-primary btn-block">Renew</button></a></td>
