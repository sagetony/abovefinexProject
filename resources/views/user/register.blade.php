...
<head>
    ...
    <title>Create a new Account | AboveFinex Forex Investment Limited</title>
    <!-- Favicon icon -->
                                ...
                                <div class="auth-form">
									...
									<form action="{{ route('register') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Your Referral (Optional)" name="referral" value="{{ $id }}">
                                        </div>
                                        <div class="form-group">
